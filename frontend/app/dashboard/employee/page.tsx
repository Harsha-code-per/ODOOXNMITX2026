...
export default function EmployeeDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6 animate-in fade-in">
      ...
      {/* Center Layout: Live Timer + Recent Activity */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Col (1 col): Live Attendance Pulse Widget */}
        <div className="lg:col-span-1">
          <LiveTimerPulse employeeId={employeeId} onStatusChange={refreshData} />
        </div>

        {/* Right Col (2 cols): Recent Attendance History */}
        <div className="lg:col-span-2 glass-panel rounded-3xl p-6 border border-slate-200 shadow-sm flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-4 pb-3 border-b border-slate-100">
              <div>
                <h3 className="text-sm font-bold text-slate-900 flex items-center gap-2">
                  <Calendar className="w-4 h-4 text-cyan-600" /> Recent Attendance History
                </h3>
