...
import enum
from sqlalchemy import Column, String, Date, DateTime, JSON, ForeignKey, Enum as SAEnum, Text, UniqueConstraint
...
class Employee(Base):
    ...
    employee_id = Column(String(50), nullable=False, index=True)  # e.g. EMP-001 (unique per company)
